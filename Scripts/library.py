...
class Library:
    ...
    def add_address(self, address: Address) -> int:
        ...
        """
        result = self.db.execute_query(query, (address.city, address.street), return_result=True)
    ...
    def add_author(self, author: Author) -> int:
        ...
        author_id = self.db.execute_query_returning(query, (author.name,), return_result=True)
